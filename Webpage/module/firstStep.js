 ...
 */
export const getCompareScore = function (leonScore, judyScore) {
 ...
 * @return {number}
 */
export const getFinalScore = function (indexArr, pokerScoreArr) {
 ...
 */
export const findTwoCardsIndex = function (arr) {
    let l = arr.length,
 ...
 * @return {number[]}
 */
export const getScoreArr = function (str) {
    //卡值对应
    let matchAJQK = {
        A: 1,
        J: 10,
