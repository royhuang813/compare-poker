 ...
 */
exports.getCompareScore = function (leonScore, judyScore) {
 ...
 * @return {number}
 */
exports.getFinalScore = function (indexArr, pokerScoreArr) {
 ...
 */
exports.findTwoCardsIndex = function (arr) {
    let l = arr.length,
 ...
 * @return {number[]}
 */
exports.getScoreArr = function (str) {
    //卡值对应
    let matchAJQK = {
        A: 1,
        J: 10,
